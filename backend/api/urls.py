...
from .views import RoomListView, RoomDetailView, CreateRoomView, JoinRoomView, UserInRoom, LeaveRoom, UpdateRoom
...
urlpatterns = [
    ...
    path('room/update', UpdateRoom.as_view(), name='room_update'),
]
